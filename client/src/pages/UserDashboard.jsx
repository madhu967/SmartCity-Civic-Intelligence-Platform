      ...
      <section className="dashboard-main">
        ...
        <div className="dashboard-container">
          ...
          <div className="dashboard-lower-grid">
            ...
            <section className="dashboard-panel"><div className="dashboard-panel-heading"><h2>Profile</h2><a href="/profile">View details</a></div><div className="dashboard-profile"><div className="dashboard-avatar">{user.profileImage ? <img src={user.profileImage} alt={`${user.name} profile`} /> : initials}</div><div><strong>{user.name}</strong><span className="capitalize">{user.role} account</span></div></div><dl className="dashboard-profile-details"><div><dt>Email</dt><dd>{user.email}</dd></div><div><dt>Phone</dt><dd>{user.phone || 'Not added yet'}</dd></div><div className="dashboard-connected"><MapPin size={14} /> Connected to your community</div></dl></section>
          </div>
        </div>
      </section>
    </main>
