      ...
      <section className="dashboard-main">
        ...
        <div className="dashboard-container">
          <div className="dashboard-heading-row">
            ...
            <button type="button" className="dashboard-primary-button"><Plus size={17} /> Report an issue</button>
          </div>

          <div className="dashboard-stat-grid">
            <div className="dashboard-stat-card"><div className="dashboard-stat-top"><span>My reports</span><ClipboardList size={18} /></div><strong>0</strong><small>No reports submitted yet</small></div>
