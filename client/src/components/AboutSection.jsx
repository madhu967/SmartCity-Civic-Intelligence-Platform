...
const principles = [
  {
    ...
    description:
      "Every signal starts with a person. We give communities a clearer voice and city teams the context to act with care.",
    icon: Users,
  },
  {
    id: "clarity",
    ...
    description:
      "We turn noise into a shared operating picture, so the right team sees the right problem at the right moment.",
    icon: Eye,
  },
  {
    id: "scale",
    ...
    description:
      "A flexible intelligence layer helps every department move faster without asking cities to replace what already works.",
    icon: Globe2,
  },
];
...
export default function AboutSection() {
  ...
  const active = principles.find(
    (principle) => principle.id === activePrinciple,
  );
        ...
        <div className="mb-16 flex flex-col justify-between gap-8 lg:mb-24 lg:flex-row lg:items-end">
          <div className="max-w-3xl">
            ...
            <h2 className="max-w-3xl text-4xl font-bold leading-[1.08] tracking-tight text-brand-950 sm:text-5xl lg:text-6xl">
              Cities are alive.{" "}
              <span className="font-normal italic text-brand-600">
                We help them listen.
              </span>
            </h2>
          </div>
          <p className="max-w-xs text-sm leading-7 text-slate-600 lg:mb-2">
            Civic Intelligence connects the lived experience of a city to the
            people responsible for making it better.
          </p>
        </div>
            ...
            <div className="relative flex h-full min-h-115 flex-col justify-between">
              ...
              <div>
                ...
                <p className="max-w-lg text-2xl font-medium leading-tight tracking-tight sm:text-4xl">
                  “The best civic technology makes progress visible to
                  everyone.”
                </p>
            ...
            <div className="grid flex-1 grid-cols-2 gap-5">
              <div className="relative min-h-60 overflow-hidden rounded-4xl bg-brand-100 p-6">
                ...
                <div className="relative flex h-full flex-col justify-between">
                  <span className="text-[10px] font-bold uppercase tracking-[0.18em] text-brand-900">
                    Since 2018
                  </span>
                  <p className="max-w-37.5 text-2xl font-bold leading-none tracking-tight text-brand-900">
                    Built for the places we call home.
                  </p>
                </div>
              </div>
              <div className="flex min-h-60 flex-col justify-between rounded-4xl bg-brand-200 p-6 text-brand-950">
                ...
                <div>
                  <div className="text-6xl font-bold tracking-[-0.08em]">
                    40<span className="text-3xl">+</span>
                  </div>
                  <p className="mt-1 max-w-35 text-xs font-medium leading-5">
                    cities turning insight into action
                  </p>
                </div>
              </div>
            </div>
